...
walker_spawn_point = carla.Transform(carla.Location(x=vehicle_spawn_loc.x-31.8, y=vehicle_spawn_loc.y-5.8, z=1.300000), carla.Rotation(pitch=0.000000, yaw=90, roll=0.000000))
