...
#end_point = spawn_points[168]
end_point_location = carla.Location(x=vehicle_spawn_loc.x-35, y=vehicle_spawn_loc.y-50.8, z=1.300000)
...
walker_spawn_point = carla.Transform(carla.Location(x=vehicle_spawn_loc.x-33.8, y=vehicle_spawn_loc.y-9.5, z=1.300000), carla.Rotation(pitch=0.000000, yaw=0, roll=0.000000))
...
traffic_manager.set_path(vehicle, [end_point_location])
